		    ...
		    <div class="col-xs-12 col-sm-12 col-md-12">
                ...
                <div class="form-inline">
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    <strong>Sex:</strong>
                                  <input class="form-check-input" type="radio" name="exampleRadios" id="sex" value="M">
                                  <label class="form-check-label" for="exampleRadios1">M</label>

                                  <input class="form-check-input" type="radio" name="exampleRadios" id="sex2" value="F">
                ...
                <div class="form-inline">
                            <div class="form-group">
                                ...
                                <input type="text" name="addres" value="" class="form-inline" placeholder="Address"  maxlength="85" size="85" >
                            </div>
                </div>
                ...
                <div class="form-inline">
                            <div class="form-group">
                                ...
                                <input type="text" name="nxOfKin" value="" class="form-inline" placeholder="Near relative">
                            </div>
                            <div class="form-group">
                ...
                <div class="form-inline">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" value="" class="form-inline" placeholder="Contac Infotmation"  maxlength="70" size="70">
                            </div>
                </div>
