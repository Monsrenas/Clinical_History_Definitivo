...
<!--
	$others="<div id='med"+$med+"'><tr><td><input type='text' class='form-control' name='drugname[]'  value='"+$vDrug+"' maxlength='50' size='50'></td><td><input type='text' class='form-control' name='dose[]'  value='"+$vDose+"'></td><td><input type='text' class='form-control' name='time[]'  value='"+$vtime+"'></td><td> <a href='javascript:delelm(\"med"+$med+"\")' class='btn btn-success'><span class='glyphicon glyphicon glyphicon-minus' aria-hidden='true'></span> Delete</a></div> </td></tr></div>";-->
