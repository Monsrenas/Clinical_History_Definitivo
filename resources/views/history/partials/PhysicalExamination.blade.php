	...
	<?php 	
	  ...
	  function decifra($cadena) { 
	  		...
	  		if ($cadena=="***") { $i=indice(1); 
	  			$resu=" <td width='10' > <input type='radio' name='N".$i."' value='N'> </td> <td width='10'> <input type='radio' name='N".$i."' value='AN'> </td><td width='10'> <input type='radio' name='N".$i."' value='NE'> </td> ";}
	  		if (substr($cadena, 0,1)=="#") {$i=indice(2); 
	  					$nomb=str_replace(" ", "", substr($cadena, 2,-1));
	  					$resu="<td colspan='".substr($cadena, 1,1)."'>".substr($cadena, 2)." <input type='text' name='".$nomb.$i."' size='5'> </td>";}
	  		if ($cadena=="DAF") { $resu="<td rowspan='90'> <textarea style='resize: none;' rows = '100%' cols = '80%' name = 'DAF'></textarea> </td>"; }

	  		if ($cadena=="...") {$i=indice(1);
	  			 $resu=" <input type='radio' name='N".$i."' value='N'> <input type='radio' name='N".$i."' value='AN'> <input type='radio' name='N".$i."' value='NE'>";}
